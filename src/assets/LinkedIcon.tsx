...
function LinkedIcon() {
  return (
    <div>
      ...
      >
        <g filter="url(#filter0_ii_147_471)">
          <ellipse cx="20" cy="19.9987" rx="20" ry="19.9987" fill="#D9D9D9" />
        </g>
        <rect x="8" y="8" width="28.2222" height="24" fill="url(#pattern0)" />
        <defs>
          <filter
            id="filter0_ii_147_471"
            x="-0.5"
            y="-0.5"
            width="41"
            height="41.4973"
          ...
          >
            ...
            <feBlend
              mode="normal"
              in2="shape"
              result="effect1_innerShadow_147_471"
            />
            <feColorMatrix
              in="SourceAlpha"
              type="matrix"
            ...
            <feBlend
              mode="normal"
              in2="effect1_innerShadow_147_471"
              result="effect2_innerShadow_147_471"
            />
          </filter>
          <pattern
            id="pattern0"
          ...
          >
            <use
              xlinkHref="#image0_147_471"
              transform="scale(0.0015748 0.00185185)"
            />
          </pattern>
          <image
            id="image0_147_471"
