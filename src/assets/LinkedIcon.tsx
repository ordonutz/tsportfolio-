...
function LinkedIcon(props: linkedIconProps) {
  return (
    <div onClick={props.onClick}>
      ...
      >
        <g filter="url(#filter0_ii_165_380)">
          <ellipse
            cx="18.5"
            cy="18.4988"
            rx="18.5"
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              mode="normal"
              in2="shape"
              result="effect1_innerShadow_165_380"
            />
            <feColorMatrix
              in="SourceAlpha"
              type="matrix"
            ...
            <feBlend
              mode="normal"
              in2="effect1_innerShadow_165_380"
              result="effect2_innerShadow_165_380"
            />
          </filter>
          <pattern
            id="pattern0"
